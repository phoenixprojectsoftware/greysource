...
class CZai : public CTalkMonster
{
public:
	void Spawn( void );
	void Precache( void );
...
LINK_ENTITY_TO_CLASS( monster_zamn_zai, CZai );

TYPEDESCRIPTION	CZai::m_SaveData[] = 
{
	DEFINE_FIELD( CZai, m_painTime, FIELD_TIME ),
	DEFINE_FIELD( CZai, m_healTime, FIELD_TIME ),
	DEFINE_FIELD( CZai, m_fearTime, FIELD_TIME ),
};

IMPLEMENT_SAVERESTORE( CZai, CTalkMonster );
...
IMPLEMENT_CUSTOM_SCHEDULES( CZai, CTalkMonster );


void CZai::DeclineFollowing( void )
{
	Talk( 10 );
...
Activity CZai::GetStoppedActivity( void )
{ 
	if ( m_hEnemy != NULL ) 
		return ACT_EXCITED;
...
void CZai :: StartTask( Task_t *pTask )
{
	switch( pTask->iTask )
	{
	case TASK_SAY_HEAL:
...
void CZai :: RunTask( Task_t *pTask )
{
	switch ( pTask->iTask )
	{
	case TASK_RUN_PATH_SCARED:
...
//=========================================================
void CZai :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	switch( pEvent->event )
	{		
...
//	m_flDistTooFar		= 256.0;
	...
	MonsterInit();
	SetUse( &CZai::FollowerUse );
}

//=========================================================
// Precache - precaches all resources this monster needs
//=========================================================
void CZai :: Precache( void )
{
...
void CZai :: TalkInit()
{
	...
	m_szFriends[0] = "monster_zamn_zai";
...
int CZai :: TakeDamage( entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType)
{
...
// DeathSound 
//=========================================================
void CZai :: DeathSound ( void )
{
	PainSound();
}


void CZai::Killed( entvars_t *pevAttacker, int iGib )
{
	SetUse( NULL );	
...
void CZai :: SetActivity ( Activity newActivity )
{
	int	iSequence;
...
Schedule_t* CZai :: GetScheduleOfType ( int Type )
{
	Schedule_t *psched;
...
Schedule_t *CZai :: GetSchedule ( void )
{
...
MONSTERSTATE CZai :: GetIdealState ( void )
{
	switch ( m_MonsterState )
	{
	case MONSTERSTATE_ALERT:
...
int CZai::FriendNumber( int arrayNumber )
{
...
// Dead Scientist PROP
//=========================================================
class CDeadZai : public CBaseMonster
{
public:
	void Spawn( void );
...
const char *CDeadZai::m_szPoses[] = { "lying_on_back", "lying_on_stomach", "dead_sitting", "dead_hang", "dead_table1", "dead_table2", "dead_table3" };

void CDeadZai::KeyValue( KeyValueData *pkvd )
{
...
LINK_ENTITY_TO_CLASS( monster_zamn_zai_dead, CDeadZai );
...
class CSittingZai : public CZai // kdb: changed from public CBaseMonster so he can speak
{
public:
	void Spawn( void );
	void  Precache( void );
...
LINK_ENTITY_TO_CLASS( monster_sitting_scientist, CSittingZai );
TYPEDESCRIPTION	CSittingZai::m_SaveData[] = 
{
	// Don't need to save/restore m_baseSequence (recalced)
	DEFINE_FIELD( CSittingZai, m_headTurn, FIELD_INTEGER ),
	DEFINE_FIELD( CSittingZai, m_flResponseDelay, FIELD_FLOAT ),
};

IMPLEMENT_SAVERESTORE( CSittingZai, CZai );
...
void CSittingZai :: Spawn( )
{
	...
	SetThink (&CSittingZai::SittingThink);
	pev->nextthink = gpGlobals->time + 0.1;

	DROP_TO_FLOOR ( ENT(pev) );
}

void CSittingZai :: Precache( void )
{
	m_baseSequence = LookupSequence( "sitlookleft" );
	TalkInit();
}
...
//=========================================================
int	CSittingZai :: Classify ( void )
{
	return	CLASS_HUMAN_PASSIVE;
}


int CSittingZai::FriendNumber( int arrayNumber )
{
...
// sit, do stuff
//=========================================================
void CSittingZai :: SittingThink( void )
{
	CBaseEntity *pent;	
...
void CSittingZai :: SetAnswerQuestion( CTalkMonster *pSpeaker )
{
...
//=========================================================
int CSittingZai :: FIdleSpeak ( void )
{ 
