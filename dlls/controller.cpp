...
void CControllerHeadBall :: HuntThink( void  )
{
	...
	if (gpGlobals->time - pev->dmgtime > 5 || pev->renderamt < 64 || m_hEnemy == NULL || m_hOwner == NULL || pev->origin.x < -16384 || pev->origin.x > 16384 || pev->origin.y < -16384 || pev->origin.y > 16384 || pev->origin.z < -16384 || pev->origin.z > 16384)
	{
		SetTouch( NULL );
		UTIL_Remove( this );
		return;
