...
#define build "Grey Source 2020 Propietary [build 2005-Z]"
#define gameSdk "https://github.com/phoenixprojectsoftware/zamnhl-sdk"
#define engineSdk "https://github.com/phoenixprojectsoftware/greysource"